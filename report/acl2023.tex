...
% Remove the "review" option to generate the final version and show the authors. 
\usepackage[]{ACL2023}
...
\title{Conversational Agents — Group 1}
...
\author{Aron Szeles, Jason Sweeney, Charlie Lyttle, Jack Miller, Cale Clark, Zein Said, \\{\bf Laura Schauer, Abdullah Sayed, Katie McAskill, Xander Wickham, Tom Byars,  Roman Fenlon} \\
