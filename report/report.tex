...
\begin{itemize}
  \item Talk about multi-party data collection
  \item There’s a need to collect data of multi-party human robot interaction because there’s proof that humans behave differently when they interact with each other vs. interact with a robot.To justify why we still went with human-human data is that there’s only little data available of human-robot interaction and there wasn’t enough time in the period of this project to collect it by ourselves.
\end{itemize}
...
\begin{itemize}
  \item Description of RASA
  \item Different versions of the model: show difference in F-Score
\end{itemize}
