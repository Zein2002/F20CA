...
As the annotations are used to train the system, ensuring that they are reliable and consistent is essential for accurate training. Cohen's kappa is used on a sample of the completed transcripts to evaluate their accuracy. Cohen's kappa measures the reliability between multiple raters on categorical data. It is more accurate than calculating just the agreement rate as it accounts for agreements happening by chance. \cite{McHugh_2012}
...
According to Cohen \cite{McHugh_2012}, a Kappa score of 0.9601 is interpreted as almost perfect agreement. From this, the annotation of transcripts can be concluded as reliable and therefore the training model will accurately learn from this data.
